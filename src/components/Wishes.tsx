...
const WISHES: Wish[] = [
  {
    icon: Trophy,
    title: "Sukses Selalu",
    text: "Semoga tiap langkahmu membawa pencapaian yang bikin bangga orang lain.",
    from: "#A78BFA",
    to: "#7C5CE0",
  },
  {
    icon: HeartPulse,
    title: "Sehat",
    text: "Semoga sehat selalu, kuat-kuat, panjang-panjang, dan full energy tiap hari loh ya.",
    from: "#F9A8D4",
    to: "#EC4899",
  },
  {
    icon: Smile,
    title: "Bahagia",
    text: "Semoga hari-harimu selalu ditemani tawa dan kebahagiaan mas brok.",
    from: "#E8C170",
    to: "#D4AF37",
  },
  {
    icon: Sparkles,
    title: "Mimpi",
    text: "Semoga semua mimpimu pelan-pelan jadi kenyataan, AMINN!!!.",
    from: "#C4B5FD",
    to: "#A78BFA",
  },
];
